...
const orderModifier = (order) => {
  // Adicione abaixo as informações necessárias.
  const modify = order['name'] = 'Luiz Silva';
  const price = order.payment['total'] = 50;
  return `Olá, ${modify}, o total do seu pedido de ${Object.keys(order.order.pizza)[0]}, ${Object.keys(order.order.pizza)[1]} e ${order.order.drinks.coke['type']} é R$${price},00`
